 ...
 * object.
 */
export function bindRequests(target: any, channel: Backbone.Radio.Channel, bindings: any): void;

/**
 * This method is used to unbind a radio requests to methods on a target
 * object.
 */
export function unbindRequests(target: any, channel: Backbone.Radio.Channel, bindings: any): void;
...
export class Object extends Backbone.Events implements CommonMixin, RadioMixin {
     ...
     * object.
     */
    bindRequests(channel: Backbone.Radio.Channel, bindings: any): void;

    /**
     * This method is used to unbind a radio requests to methods on a target
     * object.
     */
    unbindRequests(channel: Backbone.Radio.Channel, bindings: any): void;
